...
import {consoleLog, quickLet, quickConst, quickEqual, quickString, quickNumber, quickPrivate, quickPublic, quickArror, quickCurlyBrackets, quickCurlyBracketsLeft, quickSurround, quickSurroundSuper, quickStringAttr, quickMethod} from './mayiwen/quickJs';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(consoleLog, quickLet, quickConst, quickEqual, quickString, quickNumber, quickPrivate, quickPublic, quickArror, quickCurlyBrackets, quickCurlyBracketsLeft,quickSurround, quickSurroundSuper, quickStringAttr, quickMethod);
}
